const layout = {
  ...
  pen: 'overflow-y-auto grid grid-cols-[200px_400px_auto]',
  list: 'hidden sm:block sm:relative bg-neutral-900',
  items:
    'absolute z-20 top-0 left-0 w-full h-full overflow-y-auto flex flex-col',
  editor: 'h-1/2 sm:h-full overflow-y-auto',
  stage: 'h-1/2 sm:h-full relative',
  html: 'grid place-items-center h-full',
  progress: 'absolute left-0 right-0 bottom-10 flex gap-2 justify-center overflow-hidden',
  progressStep: {
